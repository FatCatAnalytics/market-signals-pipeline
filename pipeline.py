...
============================================================
Reads a CSV of companies, fetches news via Tavily, classifies signals
with your local llama-server, and writes a pixel-perfect Excel report.
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        ...
        description=(
            ...
            "for a list of companies using Tavily + local llama-server."
        ),
